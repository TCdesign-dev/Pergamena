...
const TRATTI = {
  ...
  'domanda': <><path d="M3.5 6a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2H9l-3.5 3v-3a2 2 0 0 1-2-2z" /><path d="M8.3 7.4a1.8 1.8 0 0 1 3.4.8c0 1.2-1.7 1.4-1.7 2.4" /><circle cx="10" cy="12.4" r=".55" fill="currentColor" stroke="none" /></>,
